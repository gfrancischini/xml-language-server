...
namespace XmlCompletionEngine
{
    public class XmlSchemaDefinition
    {
        ...
        /// <returns></returns>
        public XmlObjectLocation GetSelectedSchemaObjectLocation(string xml, int index)
        {
            ...
            return new XmlObjectLocation(schemaObject.LineNumber, schemaObject.LinePosition, new Uri(schemaObject.SourceUri));
        }
